...
def page(fname,title,body,css='',bodyattr='data-skin="magazine"',extra_js=''):
...
IMG=['px-274422','wm-bball-jp','wm-karate','wm-kidsrun-1','px-3755440','wm-outdoor','px-3448250','px-399187','px-209977']
...
CLUBS=[('px-274422','サッカー ・ 小学1〜6年','6年生が、1年生の靴をそろえる','わかばFC','世田谷区 桜丘 ・ 千歳船橋駅 徒歩8分<br>週2回（土日） ・ 月謝5,000円',True),
...
'''%("\n".join(cards_html),"\n".join(rec_html))
page('search-preview.html','世田谷区のサッカークラブ 14件｜チビスポ（検索結果プレビュー）',search_body,search_css,extra_js="<script>(function(){var t=document.getElementById('ftog'),a=document.getElementById('fside');if(t&&a)t.addEventListener('click',function(){a.classList.toggle('open')})})();</script>")
...
mcs=[mc(0,'px-274422','6年生が、1年生の靴をそろえる','わかばFC','サッカー ・ 千歳船橋 徒歩8分 ・ 月謝5,000円',True),
...
'''
ARTS=[('クラブ選び','「うちの子に合うクラブ」の見つけ方・5つの視点','2026.06.12','px-274422'),
...
<main><div class="wrap">
  ...
  <div class="feat"><img src="assets/preview-video/px-274422.jpg" alt=""><div class="t"><div class="c">クラブ選び ・ 特集</div><h2>「うちの子に合うクラブ」の見つけ方・5つの視点</h2><p>強いか弱いかより先に見るところがあります。見学の前に、5つだけ。</p></div></div>
  <div class="mgrid">%s</div>
  <div style="height:40px"></div>
</div></main>
'''%(chip('すべて',True),chip('クラブ選び'),chip('コーチの想い'),chip('子どもの一歩'),chip('はじめて'),mi)
page('magazine-preview.html','マガジン｜チビスポ（プレビュー）',mag_body,mag_css)
...
'''
page('article-preview.html','6歳までの運動が、脳を育てる｜チビスポ マガジン（プレビュー）',art_body,art_css)
...
'''
pt_body='''
<div class="phero"><img src="assets/preview-video/px-274422.jpg" alt=""><div class="in">
...
<main><div class="wrap">
  ...
  <div class="two">
    ...
    <div class="c"><div class="k">PARTNERS</div><h3>企業として広告したい</h3><p>整骨院・スポーツ用品店・塾・クリニックなど。地域の子育て世帯が見るクラブページに、お店を載せられます。</p><a class="btn ghost" href="#">広告のご案内を見る</a></div>
  </div>
...
'''
page('partner-preview.html','クラブ・事業者の方へ｜チビスポ（プレビュー）',pt_body,pt_css)
  ...
  <div class="sd">
    ...
    <div class="res">
      ...
      <div class="alt"><div class="t">はじめての方は、こちらも</div>
        <div class="arts">
          <div class="art"><div class="b"><h3>「うちの子に合うクラブ」の見つけ方・5つの視点</h3><div class="m"><b>クラブ選び</b>2026/06/12</div></div><img src="assets/preview-video/px-274422.jpg" alt=""></div>
...
page('shindan-preview.html','3つの質問でさがす｜チビスポ（プレビュー）',sd_body,sd_css,extra_js=sd_js)
print('done')
