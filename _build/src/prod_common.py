...
V='20260915'   # キャッシュ破り（site.css / chrome.css / shared.js / club-card.js）
LINKS=dict(home='index.html',search='search.html',map='map.html',about='about.html',partner='partner.html',fav='mypage.html#fav',clubmy='club-mypage.html',login='login.html',mypage='mypage.html',listing='listing.html',magazine='magazine.html',faq='faq.html',contact='contact.html',terms='legal.html#terms',privacy='legal.html#privacy',logo='assets/logo-sm.png',logow='assets/logo-wide.webp')
